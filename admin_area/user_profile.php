...
$admin_contact = $row_admin['numtel_admin'];
...
<button type="button" class="btnChanger" id="pswd" 
onclick="location.href='ChangerPswd.php';">Change password
<i class="fa fa-lock fa-lg"></i></button> </div>
</div><!-- col-md-6 Ends -->
...
,admin_image='$admin_image',admin_contact='$admin_contact',admin_about='$admin_about' where admin_id='$admin_id'";
